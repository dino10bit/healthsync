...
| R-69 | **Architecture** | **(Mitigated)** The initial architecture projected a worst-case of ~45,000 concurrent Lambda executions, which was financially and technically infeasible. This risk has been mitigated by re-architecting the worker fleet to use AWS Fargate. | **Low** | **Critical** | **Low** |
